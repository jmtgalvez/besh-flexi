...
export default function PostCard({ userPostPhoto, post, setPost }) {
  ...
  const toggleLike = post_id => {
    isLiked ? unlikePost(post.post_id) : likePost(post.post_id); 
    ...
    <div className='mt-3 w-100'>
      <div className="newsfeeds-content p-3 d-flex flex-column gap-4 card"style={{ cursor: 'pointer'}}>
        ...
        <div className="row gap-2">
          <div className="col-md-1 align-items-center justify-content-center" onClick={toggleLike} style={{cursor: 'pointer'}}>
          ...
          </div>
          {
            post.reply_id ? (
              ...
              <form onSubmit={sendComment}  className='d-flex col-md-10 gap-5'>
