...
export default function Help() {
  return (
    <div className="card p-3">
      <div className="card-title ms-3"><h3>FAQ</h3></div>
      <div className="accordion accordion-flush" id="accordionFlushExample">
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              Placeholder content for this accordion, which is intended to demonstrate the{" "}
              <code>.accordion-flush</code> className. This is the second item's accordion body. Let's
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body">
              Placeholder content for this accordion, which is intended to demonstrate the{" "}
              <code>.accordion-flush</code> className. This is the third item's accordion body. Nothing
